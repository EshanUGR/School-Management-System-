    ...
    <SidebarContainer style={{ width: isOpen ? "250px" : "80px" }}>
      ...
      <SidebarNav>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/admin/students">Student</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon>
            <BsPerson />
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/admin/assigments">Assigments</StyledLink>
        </SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/admin/events">Event and Profile</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon>
            <BsGear />
