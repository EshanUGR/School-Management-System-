    ...
    <SidebarContainer style={{ width: isOpen ? "250px" : "80px" }}>
      ...
      <SidebarNav>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/student/assigments">Assigments</StyledLink>
        </SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/student/libarary">Libarary</StyledLink>
        </SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/admin/events">Event and Calendar</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon>
            <BsGear />
